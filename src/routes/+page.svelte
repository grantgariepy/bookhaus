...
<div class="bg-zinc-800 py-6 sm:py-8 lg:py-12">
	<div class="max-w-screen-xl px-4 md:px-8 mx-auto">
		<div
			class="grid grid-cols-3 lg:grid-cols-6 xl:grid-cols-6 gap-x-4 md:gap-x-6 gap-y-8 "
		>
			<!-- product - start -->
			<div>
				<a
				...
				<div>
					<a
						href="/"
						class="text-gray-500 hover:gray-800 lg:text-lg transition duration-100 mb-4"
						>It</a
					>
				</div>
			</div>
