	...
	<div class="max-w-screen-lg px-4 md:px-8 mx-auto">
		...
		>
			...
			<div>
				<a
					href="/"
					class="hover:border-none  inset-0  group h-64 block bg-gray-100 rounded-md overflow-hidden relative mb-2 lg:mb-3"
				>
					<img
						...
						>
							...
							<div class="absolute inset-6">
								<div class="flex flex-col py-4 gap-2">
									...
									<p
										class="text-zinc-100 self-center text-2xl"
									>
										203,634
									</p>
									<svg
			...
			<div>
				<a
					href="/"
					class="group h-64 block bg-gray-100 rounded-md overflow-hidden relative mb-2 lg:mb-3"
				>
					<img
